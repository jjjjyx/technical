 ...
 <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
	...
	<div class="collapse navbar-collapse" id="example-navbar-collapse">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li>
				<p class="navbar-text">已有账号我要</p>
				<button class="btn btn-primary navbar-btn" id="load_btn">登录</button>
				<button class="btn btn-success navbar-btn" onclick="window.location.href='${path}/signup-one.jsp'">注册</button>
				</li>
			</c:if>
			...
			<li class="hidden-xs hidden-sm notification-dropdown">
				<a href="#" class="trigger" style="font-size: 17px; color: #9ba3ad">
                    ...
                    <span class="count"><%
                        		List<Object> l=(List<Object>)request.getAttribute("mycommentlist");
                        		if(l!=null){
                        			out.print(l.size()==0?"":l.size());
                        		}
                        	%></span>
                </a>
                    ...
                    <div class="body">
                        ...
                        <c:forEach var="l" items="${mycommentlist }">
                            <a href="#" class="item">
                                ...
                                <span class="time"><i class="icon-time"></i> ${l['comment_time'] }前.</span>
                            </a>
                            </c:forEach>
                            <%if(l==null) {%>
                            	 <a href="#" class="item">
                            ...
                            <%} %>
                            <div class="footer">
                                <a href="${path }/user!mycomment" class="logout">查看所有消息</a>
                            </div>
                        </div>
                    </div>
                </div>
